...
**LightGBM-Baseline 三市场结果（固定 train/test 切分）：**

| 市场 | 特征数 | MAE | RMSE | Profile Corr | best_iter |
|------|--------|-----|------|--------------|-----------|
| 内蒙 | 44 | 98.51 | 124.11 | 0.7838 | 40 |
| 重庆 | 47 | 94.93 | 169.62 | 0.1724 | 2 |
| 江苏 | 47 | 82.60 | 103.80 | 0.5500 | 135 |

**LightGBM-TwoStage 三市场结果（Expanding Window CV）：**

| 市场 | 特征数 | CV 折数 | Model MAE | Naive MAE | RMSE | Profile Corr | 相对 Naive 提升 |
|------|--------|---------|-----------|-----------|------|--------------|------------------|
| 内蒙 | 208 | 12 | 82.76 | 157.93 | 113.41 | 0.7494 | +47.6% |
| 重庆 | 171 | 6 | 110.47 | 101.61 | 144.92 | 0.2271 | −8.7% |
| 江苏 | 241 | 9 | 53.36 | 74.13 | 72.52 | 0.7545 | +28.0% |

**两算法横向比较（MAE，单位 元/MWh）：**

| 市场 | Baseline | TwoStage | 最优 |
|------|----------|----------|------|
| 内蒙 | 98.51 | **82.76** | TwoStage (−16.0%) |
| 重庆 | **94.93** | 110.47 | Baseline (−14.1%) |
| 江苏 | 82.60 | **53.36** | TwoStage (−35.4%) |

> 详细分析见项目根目录 `RESULTS.md`。
