...
| 市场 | LightGBM-Baseline | LightGBM-TwoStage |
|------|-------------------|-------------------|
| 内蒙古 | 0.7838 | — |
| 重庆 | 0.1724 | — |
| 江苏 | 0.5500 | — |

> 注：LightGBM-TwoStage 当前未输出 Profile Correlation，待后续补充。
...
| 市场 | MAE | RMSE | CV Folds | 特征数 |
|------|-----|------|----------|--------|
| 内蒙古 | 82.76 | 113.41 | 12 | 200+ |
| 重庆 | 110.47 | 144.92 | 6 | 200+ |
| 江苏 | 53.36 | 72.52 | 9 | 200+ |
